...
def get_data_car(catalog_namber_car, ssd_car):
    '''Функция
    :param catalog_namber_car, ssd_car: описание
    :return car_infо, car_details: что возвращает
    '''
    car_infо = get_car_info(catalog_namber_car, ssd_car)
